  ...
  return (
    <Container>
      <FooterWrapper>
        <Row>
          <Col>
            ...
            <SiteLink href='https://github.com/ashish12501' target='_blank'>
              Github
            </SiteLink>
            <SiteLink
            ...
            <SiteLink href='https://twitter.com/AshishYadav0793' target='_blank'>
              Twitter
            </SiteLink>
            <SiteLink href='https://ashishcodes.hashnode.dev/' target='_blank'>
              Hashnode
            </SiteLink>
          </Col>
          {/* col 2 */}
      ...
      <Attribution>
        ...
        <a
          href='https://github.com/ashish12501'
          rel='noreferrer'
          target='_blank'
        >
          Ashish Yadav
